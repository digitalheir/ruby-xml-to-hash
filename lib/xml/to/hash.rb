  ...
  module XML
    ...
    class ElementContent
      ...
      def to_hash
        ...
        if occur
          hash[:occur] = Xml::To::Hash.get_from_map_or_raise(OCCUR_TO_SYMBOL_MAP, occur)
        end
        if type
          hash[:type] = Xml::To::Hash.get_from_map_or_raise(TYPE_TO_SYMBOL_MAP, type)
        end
    ...
    class Node
      ...
      def to_hash
        ...
        if node_type == Nokogiri::XML::Node::DTD_NODE
          set_object_array_in_hash!(hash, :elements)
          set_object_array_in_hash!(hash, :entities)
          set_object_array_in_hash!(hash, :notations)
        end
      ...
      private
      def set_object_array_in_hash!(hash, meth)
      ...
      def set_attributes_to_hash(hash)
        hash = hash.clone
        set_attributes_in_hash!(hash)
        hash
      end

      def set_attributes_in_hash!(hash)
